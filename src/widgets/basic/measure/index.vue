<!-- 图上量算 -->
<template>
  <mars-dialog title="图上量算" :visible="true" right="10" top="90" width="340" height="460">
...
const data = [
  { name: "空间距离", icon: "./img/icon/measure-length-bec89d4f.svg", rgb: [221, 117, 27], method: "measureLength" },
  { name: "水平面积", icon: "./img/icon/measure-area-b54c57a3.svg", rgb: [61, 227, 244], method: "measureArea" },
  { name: "高度差", icon: "./img/icon/measure-height-2b7aa869.svg", rgb: [85, 213, 160], method: "measureHeight" },
  { name: "坐标测量", icon: "./img/icon/measure-coor-f8425647.svg", rgb: [186, 188, 49], method: "measurePoint" },
  { name: "贴地距离", icon: "./img/icon/measure-length-bec89d4f.svg", rgb: [221, 117, 27], method: "measureSurfaceLength" },
  { name: "贴地面积", icon: "./img/icon/measure-area-b54c57a3.svg", rgb: [192, 146, 254], method: "measureSurfaceeArea" },
  { name: "三角测量", icon: "./img/icon/measure-height-sup-4927ef76.svg", rgb: [55, 188, 65], method: "measureTriangleHeight" },
  { name: "方位角", icon: "./img/icon/measure-angle-d6f4970b.svg", rgb: [149, 211, 51], method: "measureAngle" },
  { name: "剖面分析", icon: "./img/icon/measure-section-e36c0150.svg", rgb: [136, 184, 255], method: "measureSection" }
]
